...
$VCSADisplayName = "vca"
$VCSAIPAddress = "192.168.10.10"
$VCSAHostname = "vca.scanda.local" #Change to IP if you don't have valid DNS
$VCSAPrefix = "24"
...
$NewVCDatacenterName = "SiteA-Datacenter"
$NewVCVSANClusterName = "SiteA-Cluster"
$NewVCVDSName = "SiteA-VDS"
$NewVCDVPGName = "DVPG-Management-SiteA"
...
$NSXVTEPNetwork = "Overlay-SiteA" # This portgroup needs be created before running script

# Transport Node Profile
$TransportNodeProfileName = "SiteA-Host-Transport-Node-Profile"

# TEP IP Pool
$TunnelEndpointName = "TEP-IP-Pool-SiteA"
$TunnelEndpointDescription = "Tunnel Endpoint for Transport Nodes"
$TunnelEndpointIPRangeStart = "192.168.33.50"
$TunnelEndpointIPRangeEnd = "192.168.33.70"
$TunnelEndpointCIDR = "192.168.33.0/24"
$TunnelEndpointGateway = "192.168.33.254"

# Transport Zones
$OverlayTransportZoneName = "TZ-Overlay-SiteA"
$OverlayTransportZoneHostSwitchName = "nsxswitch"
$VlanTransportZoneName = "TZ-VLAN-SiteA"
$VlanTransportZoneNameHostSwitchName = "edgeswitch"

# Network Segment
$NetworkSegmentName = "SiteA-Segment"
$NetworkSegmentVlan = "0"

# T0 Gateway
$T0GatewayName = "SiteA-T0-Gateway"
$T0GatewayInterfaceAddress = "10.30.0.109" # should be a routable address
$T0GatewayInterfacePrefix = "24"
$T0GatewayInterfaceStaticRouteName = "Static-Route"
$T0GatewayInterfaceStaticRouteNetwork = "0.0.0.0/0"
$T0GatewayInterfaceStaticRouteAddress = "10.30.0.254"
...
# Edge Cluster
$EdgeClusterName = "Edge-Cluster-SiteA"

# NSX-T Manager Configurations
$NSXTMgrDeploymentSize = "small"
$NSXTMgrvCPU = "6" #override default size
$NSXTMgrvMEM = "24" #override default size
$NSXTMgrDisplayName = "nsxla1"
$NSXTMgrHostname = "nsxla1.scanda.local"
$NSXTMgrIPAddress = "192.168.10.51"
...
$NSXTGMgrDisplayName = "nsxga1"
$NSXTGMgrHostname = "nsxga1.scanda.local"
$NSXTGMgrIPAddress = "192.168.10.61"
...
$debug = $true
$verboseLogFile = "vsphere-with-nsxt-siteA.log"
$random_string = -join ((65..90) + (97..122) | Get-Random -Count 8 | % {[char]$_})
$VAppName = "SiteA-Nested-vSphere-with-NSX-T-$random_string"
